...
<head>
  ...
  <title>تعديل بيانات الطالب | Math&Play</title>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="nav">
        ...
        <div class="d-flex nav-actions gap-2">
          ...
          <a href="{{ route('mathplay.marks') }}" class="btn btn-cta">عرض العلامات</a>
    ...
    <div class="container">
      <div class="edit-container">
        <div class="edit-header">
          <h2 class="edit-title wavy-underline">تعديل بيانات الطالب</h2>
          <p class="edit-subtitle">قم بتحديث معلوماتك الشخصية</p>
        </div>
        ...
        <form method="POST" action="{{ route('mathplay.update_student') }}" id="editForm">
            ...
            <div class="form-group">
                <label class="form-label">كلمة المرور (لتغييرها فقط)</label>
                <div id="password-error" class="error-msg"></div>
                <input type="password" name="password" id="password" class="form-control" placeholder="كلمة المرور الجديدة">
            </div>
