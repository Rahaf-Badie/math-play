...
<head>
    ...
    <title>🎮 سباق الجمع - {{ $lesson_game->lesson->name ?? 'جمع عددين ضمن 999 دون حمل' }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="lesson-info">
            الدرس: {{ $lesson_game->lesson->name ?? 'جمع عددين ضمن 999 دون حمل' }}
        </div>
        ...
        <div class="game-area">
            ...
            <div class="input-container">
                <input type="number" class="answer-input" id="answer-input" placeholder="0" min="0" max="1998">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function generateAdditionProblem() {
                ...
                do {
                    ...
                    // التأكد من عدم وجود حمل في أي منزلة
