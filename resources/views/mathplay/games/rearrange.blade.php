...
<head>
    ...
    <title>ترتيب الأعداد - {{ $lesson_game->lesson->name ?? 'درس ترتيب الأعداد' }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        @media (max-width: 768px) {
            .numbers-container, .slots-container {
                gap: 10px;
            }
...
<body>
    <div class="container">
        ...
        <div class="lesson-info">
            الدرس: {{ $lesson_game->lesson->name ?? 'ترتيب الأعداد ضمن 199' }}
        </div>

        <div class="instructions">
            <p>اسحب الأعداد ورتبها في الخانات حسب التعليمات!</p>
            <p><strong>المدى:</strong> من {{ $settings->min_range ?? 10 }} إلى {{ $settings->max_range ?? 199 }}</p>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const maxRange = {{ $settings->max_range ?? 199 }};
            ...
            function generateQuestion() {
                ...
                // توليد 5 أعداد عشوائية فريدة
                currentNumbers = generateUniqueNumbers(5);
            ...
            function handleDrop(e) {
                ...
                const numberElement = document.querySelector(`.number[data-value="${numberValue}"]`);
                if (numberElement) {
