...
<head>
    ...
    <title>🎮 لعبة الجمع بدون حمل - {{ $lesson_game->lesson->name }}</title>
    <style>
        * {
...
<body>
    <div class="container">
        ...
        <h1 class="game-title">🎯 الجمع بدون حمل</h1>

        <div class="instructions">
            <p>🎯 الهدف: حل مسائل الجمع بدون حمل في منزلة الآحاد</p>
            <p>💡 تذكر: مجموع الآحاد يجب أن يكون أقل من ١٠</p>
        </div>
    ...
    <script>
        ...
        function generateQuestion() {
            ...
            while (!valid) {
                ...
                // التحقق من عدم وجود حمل في منزلة الآحاد
                const onesA = a % 10;
                const onesB = b % 10;
                valid = (onesA + onesB) < 10;
            }
        ...
        function showHelp() {
            ...
            calculationSteps.innerHTML = `
                ...
                <p>🔹 جمع الآحاد: ${onesA} + ${onesB} = ${onesA + onesB} (لا يوجد حمل)</p>
        ...
        function createConfetti() {
            ...
            const colors = ['#f1c40f', '#e74c3c', '#9b59b6', '#3498db', '#2ecc71', '#6c5ce7'];
