...
<head>
    ...
    <title>🎮 لعبة سباق الجمع - {{ $lesson_game->lesson->name }}</title>
    <style>
        * {
...
<body>
    <div class="container">
        ...
        <h1 class="game-title">🎮 سباق الجمع</h1>

        <div class="instructions">
            <p>🎯 الهدف: حل مسائل الجمع ضمن 999 دون حمل</p>
            <p>💡 تذكر: مجموع الآحاد والعشرات يجب أن يكون أقل من ١٠</p>
            <p class="no-carry-indicator">✅ لا حاجة للحمل في هذه المسائل</p>
        </div>
        ...
        <div class="game-area">
            ...
            <div class="calculation-help" id="calculation-help">
                <h3>💡 خطوات الحل:</h3>
    ...
    <script>
        ...
        const calculationHelp = document.getElementById("calculation-help");
        ...
        function generateQuestion() {
            ...
            while (!valid) {
                ...
                // التحقق من عدم وجود حمل في الآحاد والعشرات
                const onesA = a % 10;
                const onesB = b % 10;
                const tensA = Math.floor(a / 10) % 10;
                const tensB = Math.floor(b / 10) % 10;

                valid = (onesA + onesB) < 10 && (tensA + tensB) < 10;
            }
            ...
            // إخفاء المساعدة
            calculationHelp.style.display = 'none';
        }
        ...
        function showHelp() {
            ...
            calculationSteps.innerHTML = `
                <p><strong>العدد الأول:</strong> ${a} = ${hundredsA} مئات + ${tensA} عشرات + ${onesA} آحاد</p>
                <p><strong>العدد الثاني:</strong> ${b} = ${hundredsB} مئات + ${tensB} عشرات + ${onesB} آحاد</p>
                <p class="no-carry-indicator">✅ لا حاجة للحمل في أي منزلة</p>
                <hr>
                <p>🔹 جمع الآحاد: ${onesA} + ${onesB} = ${onesA + onesB}</p>
                <p>🔹 جمع العشرات: ${tensA} + ${tensB} = ${tensA + tensB}</p>
                <p>🔹 جمع المئات: ${hundredsA} + ${hundredsB} = ${hundredsA + hundredsB}</p>
                <hr>
                <p><strong>النتيجة:</strong> ${hundredsA + hundredsB} مئات + ${tensA + tensB} عشرات + ${onesA + onesB} آحاد = ${currentAnswer}</p>
            `;

            calculationHelp.style.display = 'block';
        }
        ...
        function startGame() {
            ...
            messageDisplay.textContent = "ابدأ بحل مسائل الجمع!";
