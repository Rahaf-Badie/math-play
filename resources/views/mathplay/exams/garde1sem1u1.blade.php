...
<body>
    <div class="exam-container">
        ...
        <form id="examForm">
            ...
            <!-- سؤال 1: التعرف على العدد -->
            <div class="question">
                <span class="question-number">1</span>
                <div class="question-text">ما قيمة العدد ثلاثة؟</div>
                <div class="math-operation">٣</div>
                <div class="options">
                    <input type="radio" id="q1_a" name="q1" value="3">
                    <label for="q1_a" class="option-label">٣</label>

                    <input type="radio" id="q1_b" name="q1" value="5">
                    <label for="q1_b" class="option-label">٥</label>
            ...
            <!-- سؤال 2: العدد الذي يلي -->
            <div class="question">
                <span class="question-number">2</span>
                <div class="question-text">ما العدد الذي يلي العدد خمسة؟</div>
                <div class="math-operation">٥ → ؟</div>
                <div class="options">
                    <input type="radio" id="q2_a" name="q2" value="4">
                    <label for="q2_a" class="option-label">٤</label>
            ...
            <!-- سؤال 3: العدد الذي يسبق -->
            <div class="question">
                <span class="question-number">3</span>
                <div class="question-text">ما العدد الذي يسبق العدد ثمانية؟</div>
                ...
                <div class="options">
                    ...
                    <input type="radio" id="q3_c" name="q3" value="9">
                    <label for="q3_c" class="option-label">٩</label>
            ...
            <!-- سؤال 4: مقارنة الأعداد -->
            <div class="question">
                <span class="question-number">4</span>
                <div class="question-text">أي من هذه الأعداد أكبر من العدد أربعة؟</div>
                <div class="math-operation">٤ &lt; ؟</div>
                <div class="options">
                    <input type="radio" id="q4_a" name="q4" value="3">
                    <label for="q4_a" class="option-label">٣</label>

                    <input type="radio" id="q4_b" name="q4" value="2">
                    <label for="q4_b" class="option-label">٢</label>

                    <input type="radio" id="q4_c" name="q4" value="6">
                    <label for="q4_c" class="option-label">٦</label>

                    <input type="radio" id="q4_d" name="q4" value="1">
                    <label for="q4_d" class="option-label">١</label>
                </div>
            </div>

            <!-- سؤال 5: ترتيب الأعداد -->
            <div class="question">
                <span class="question-number">5</span>
                <div class="question-text">رتب الأعداد التالية من الأصغر إلى الأكبر:</div>
                <div class="math-operation">٧ ، ٢ ، ٥</div>
                <div class="options">
                    <input type="radio" id="q5_a" name="q5" value="7,5,2">
                    <label for="q5_a" class="option-label">٧ ، ٥ ، ٢</label>

                    <input type="radio" id="q5_b" name="q5" value="2,5,7">
                    <label for="q5_b" class="option-label">٢ ، ٥ ، ٧</label>

                    <input type="radio" id="q5_c" name="q5" value="5,7,2">
                    <label for="q5_c" class="option-label">٥ ، ٧ ، ٢</label>

                    <input type="radio" id="q5_d" name="q5" value="2,7,5">
                    <label for="q5_d" class="option-label">٢ ، ٧ ، ٥</label>
                </div>
            </div>

            <!-- سؤال 6: العد التنازلي -->
            <div class="question">
                <span class="question-number">6</span>
                <div class="question-text">أكمل التسلسل: ٩ ، ٨ ، ٧ ، ؟</div>
                <div class="math-operation">٩ → ٨ → ٧ → ؟</div>
                <div class="options">
                    <input type="radio" id="q6_a" name="q6" value="6">
                    <label for="q6_a" class="option-label">٦</label>

                    <input type="radio" id="q6_b" name="q6" value="5">
                    <label for="q6_b" class="option-label">٥</label>

                    <input type="radio" id="q6_c" name="q6" value="10">
                    <label for="q6_c" class="option-label">١٠</label>
            ...
            <!-- سؤال 7: التعرف على العدد من الصورة -->
            <div class="question">
                <span class="question-number">7</span>
                <div class="question-text">إذا كان لدينا ٤ تفاحات، فما هو العدد المناسب؟</div>
            ...
            <div class="question">
                ...
                <div class="question-text">ما هو العدد الذي يقع بين ٣ و ٥؟</div>
                <div class="math-operation">٣ ← ؟ → ٥</div>
                <div class="options">
                    <input type="radio" id="q8_a" name="q8" value="2">
                    <label for="q8_a" class="option-label">٢</label>

                    <input type="radio" id="q8_b" name="q8" value="4">
                    <label for="q8_b" class="option-label">٤</label>
            ...
            <div class="question">
                ...
                <div class="question-text">ما ناتج جمع: ٢ + ٣؟</div>
                <div class="math-operation">٢ + ٣ = ؟</div>
                <div class="options">
            ...
            <!-- سؤال 10: الطرح البسيط -->
            <div class="question">
                <span class="question-number">10</span>
                <div class="question-text">ما ناتج طرح: ٨ - ٢؟</div>
                <div class="math-operation">٨ - ٢ = ؟</div>
                <div class="options">
                    <input type="radio" id="q10_a" name="q10" value="5">
                    <label for="q10_a" class="option-label">٥</label>

                    <input type="radio" id="q10_b" name="q10" value="6">
                    <label for="q10_b" class="option-label">٦</label>

                    <input type="radio" id="q10_c" name="q10" value="7">
                    <label for="q10_c" class="option-label">٧</label>

                    <input type="radio" id="q10_d" name="q10" value="10">
                    <label for="q10_d" class="option-label">١٠</label>
                </div>
            </div>
