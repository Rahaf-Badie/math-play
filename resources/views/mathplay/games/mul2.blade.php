...
<body>
    <div class="container">
        ...
        <div class="instructions">
            <p>🔢 المدى: من {{ $min_range }} إلى {{ $max_range }}</p>
    ...
    <script>
        ...
        let currentTable = 2; // جدول الضرب الحالي
        let factor1 = 0;
        let factor2 = 0;
        let product = 0;
        let score = 0;
        ...
        // استخراج جدول الضرب من اسم الدرس
        function extractTableFromLesson() {
            const lessonName = "{{ $lesson_game->lesson->name }}";
            const tableMatch = lessonName.match(/العدد (\d+)/);
